    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (input.equals("admin")) {
                ...
                String un = sc.nextLine().toLowerCase();
                System.out.println("Enter your password");
                String pa = sc.nextLine().toLowerCase();
                ...
                if (un.equals(userName) && pa.equals(password)) {
                    ...
                    System.out.println("Do you want to continue as an admin or a customer");
                    ...
                    if (input.equals("customer")) {
                        ...
                        switch (b) {
                            ...
                            case 4:
                                ClaimManagementModule.createClaim();
